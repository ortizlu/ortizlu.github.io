...
“correct” practices as possible, so we wanted a library that promoted immutability.

Sure, we could’ve just used vanilla JS. But for the amount of formatting we did as an investment company, it
...
get to the biggest hurdle, the client, in order to finally nuke Moment.js for good (R.I.P 🪦 ).
